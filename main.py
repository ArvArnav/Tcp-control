...
def main():
    ...
    try:
        ...
        # bot.run()
        print("Arnav-V2 Bot is starting safely...")
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞HUNTER BOT - INITIALIZING")
    print("=" * 50)
